...
*/
	...
	Bluetooth.prototype.disconnect = function(successCallback,failureCallback,socketid) {
	    return PhoneGap.exec(successCallback, failureCallback, 'BluetoothPlugin', 'disconnect', [socketid]);
	};
	...
	/*Bluetooth.prototype.write = function(successCallback,failureCallback,socketid,jsonarray) {
		return PhoneGap.exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [socketid,jsonarray]);
	}*/

	/**
	 * Funcion para imprimir el boucher
	 */
	Bluetooth.prototype.write = function(successCallback,failureCallback,socketid,jsonobject) {
		return PhoneGap.exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [socketid,jsonobject]);
	}
