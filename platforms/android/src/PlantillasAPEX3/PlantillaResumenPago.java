...
public class PlantillaResumenPago {
	...
	public String getResumenPago() {
		...
		*/
		...
		minutaDeposito.append("                       "+minutaNumero+"\n");
		minutaDeposito.append("J8");
		minutaDeposito.append("U1FechaU0   :    " + fecha + "            U1HoraU0: " + hora + "\n");
		minutaDeposito.append("U1RutaU0    :    " + ruta);
		minutaDeposito.append("J8");
		minutaDeposito.append("U1UUC O R D O B A SUuU0                   \n");
		minutaDeposito.append("U1Total Efectivo           C$U0 :   " + completarEspaciosIzq(totalEfectivoNIO, 10) + "\n");
		minutaDeposito.append("U1Total Cheques            C$U0 :   " + completarEspaciosIzq(totalChequeNIO, 10)+ "\n");
		minutaDeposito.append("U1Tarjeta  Credito/Debito  C$U0 :   " + completarEspaciosIzq(totalTarjetaNIO, 10)+ "\n");
		minutaDeposito.append("U1Minuta Deposito          C$U0 :   " + completarEspaciosIzq(totalMinutaNIO, 10)+ "\n");
		...
		minutaDeposito.append("J4");
		minutaDeposito.append("U1UUD O L A R E SUuU0                   \n");
		minutaDeposito.append("U1Total Efectivo          US$U0 :   " + completarEspaciosIzq(totalEfectivoUS, 10) + "\n");
		minutaDeposito.append("U1Total Cheques           US$U0 :   " + completarEspaciosIzq(totalChequeUS, 10)+ "\n");
		minutaDeposito.append("U1Tarjeta  Credito/Debito US$U0 :   " + completarEspaciosIzq(totalTarjetaUS, 10)+ "\n");
		minutaDeposito.append("U1Minuta Deposito         US$U0 :   " + completarEspaciosIzq(totalMinutaUS, 10)+ "\n");
